...
import IconCF from "@/assets/icons/Iconcf.svg";
...
export const SOCIALS = [
  ...
  {
    name: "X",
    href: "https://x.com/Jayeshpuri_21",
    linkTitle: (t: Translator) => t("socials.x"),
    icon: IconBrandX,
  },
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/wizardsea/",
    linkTitle: (t: Translator) => t("socials.linkedin"),
    icon: IconLinkedin,
  },
  {
    name: "Mail",
    href: "mailto:jayeshkpuri@gmail.com",
    linkTitle: (t: Translator) => t("socials.mail"),
    icon: IconMail,
  },
  {
    name: "CodeForces",
    href: "https://codeforces.com/profile/jayesh_dev21",
    linkTitle: (t: Translator) => t("socials.cf"),
    icon: IconCF,
  },
] as const;
